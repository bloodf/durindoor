...
- Gemini and Antigravity request translation replaces case-matched `OpenCode` branding in system prompts only, preventing provider rejection while leaving conversation content untouched. Ports decolua/9router#3454. Closes #608.
