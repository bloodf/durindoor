...
When the plan offers rate-limit reset credits, the limits view can read and spend them through `/api/usage/{connectionId}/codex-reset-credits`. Spending one resets the upstream limit and cannot be undone.
