...
Common questions about DurinDoor.

---

## What is DurinDoor?

**DurinDoor is an AI model router that maximizes your subscription value and minimizes costs.**
...
**DurinDoor uses a 3-tier pricing strategy:**
...
**Yes, DurinDoor itself is 100% free and open source.**
...
**Yes! This is DurinDoor's core feature.**
...
**DurinDoor tracks quota in real-time for all providers:**
...
## Does DurinDoor work with Cursor?

**Yes, but Cursor requires a cloud endpoint.**

**Problem:** Cursor IDE doesn't support localhost endpoints.

**Solution:** Use DurinDoor cloud deployment:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://bloodf.github.io/durindoor/v1
...
## Can I self-host DurinDoor?

**Yes! DurinDoor supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `<<~/.durindoor>>`)
...
**Yes, DurinDoor prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `<<~/.durindoor>>` (or custom `DATA_DIR`)
- No data sent to DurinDoor servers
...
**What DurinDoor stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What DurinDoor does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/bloodf/durindoor/blob/main/CHANGELOG.md)
- Backup `<<~/.durindoor>>` before major updates
...
1. **Report bugs:**
   - [GitHub Issues](https://github.com/bloodf/durindoor/issues)
   - Include error logs, steps to reproduce

2. **Request features:**
   - [GitHub Discussions](https://github.com/bloodf/durindoor/discussions)
   - Describe use case and benefits

3. **Submit code:**
   ```bash
   # Fork repo
   git clone https://github.com/YOUR_USERNAME/durindoor.git
   cd durindoor
...
See [CONTRIBUTING.md](https://github.com/bloodf/durindoor/blob/main/CONTRIBUTING.md) for details.

---

## Need More Help?

- **Documentation:** [bloodf.github.io/durindoor/docs](https://bloodf.github.io/durindoor/docs)
- **GitHub:** [github.com/bloodf/durindoor](https://github.com/bloodf/durindoor)
- **Issues:** [github.com/bloodf/durindoor/issues](https://github.com/bloodf/durindoor/issues)
