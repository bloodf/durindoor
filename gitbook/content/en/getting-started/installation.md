...
Detailed installation guide for DurinDoor with troubleshooting tips.
...
Install DurinDoor globally to use from anywhere:
...
- ✅ Simple command: `durindoor`
- ✅ Auto-updates with `npm update -g durindoor`
...
3. Data directory created at `<<~/.durindoor>>`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/durindoor'
```
...
**Issue:** DurinDoor using too much RAM
...
```bash
npm install -g pm2
pm2 start durindoor --name durindoor
pm2 save
```
...
```bash
docker pull durindoor/durindoor:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v durindoor-data:/root/.durindoor \
  --name durindoor \
  durindoor/durindoor:latest
```
...
# Delete durindoor-related exports
```
...
- **Website**: [bloodf.github.io/durindoor](https://bloodf.github.io/durindoor/)
