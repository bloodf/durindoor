...
Get DurinDoor running in 5 minutes and start routing AI requests intelligently.
...
Point your coding tool to DurinDoor:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from durindoor dashboard]
