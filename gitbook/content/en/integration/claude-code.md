...
Integrate DurinDoor with Claude Code CLI to route your Anthropic API requests through DurinDoor's intelligent routing system.
...
Claude Code supports the following model aliases that map to DurinDoor models:
...
```bash
export ANTHROPIC_BASE_URL="https://bloodf.github.io/durindoor/"
```
