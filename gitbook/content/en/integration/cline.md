...
Integrate DurinDoor with Cline VSCode extension to route your AI requests through DurinDoor's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- DurinDoor running locally or cloud endpoint configured
...
Set the base URL to your DurinDoor endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your DurinDoor endpoint
...
3. The key should start with `sk-durindoor-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your DurinDoor configuration
...
4. Cline will use DurinDoor to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using DurinDoor
...
3. Get AI-powered explanations through DurinDoor

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use DurinDoor to understand context and make changes
...
1. Verify DurinDoor is running: `curl http://localhost:20128/health`
...
2. Verify your DurinDoor instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check DurinDoor logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use DurinDoor cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://bloodf.github.io/durindoor/`
2. Make sure you have configured your API key in the DurinDoor cloud dashboard
...
## Integration with DurinDoor Features

### Model Routing

DurinDoor automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, DurinDoor automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through DurinDoor dashboard:
- Total requests
- Token usage
- Cost per model
