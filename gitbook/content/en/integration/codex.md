...
Integrate DurinDoor with OpenAI Codex CLI to route your OpenAI API requests through DurinDoor's intelligent routing system.
...
DurinDoor provides the following Codex models:
...
1. Verify your API key is correct in DurinDoor dashboard
...
1. Verify the model name matches your DurinDoor configuration
2. Check that the OpenAI provider connection is active in DurinDoor dashboard
...
```bash
export OPENAI_BASE_URL="https://bloodf.github.io/durindoor/"
```

Make sure you have configured your API key in the DurinDoor cloud dashboard.
