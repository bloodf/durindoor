...
Integrate DurinDoor with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- DurinDoor API key from [dashboard](https://bloodf.github.io/durindoor/dashboard)
- DurinDoor running (local or cloud)
...
### 2. Add DurinDoor Model Configuration
...
```json
{
  "models": [
    {
      "title": "DurinDoor - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "DurinDoor - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "DurinDoor - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "DurinDoor - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://bloodf.github.io/durindoor/v1"
```
...
3. Choose your preferred DurinDoor model
...
```json
{
  "models": [
    {
      "title": "DurinDoor - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Check network latency to DurinDoor
