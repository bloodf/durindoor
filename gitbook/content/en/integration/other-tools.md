...
DurinDoor is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

DurinDoor provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to DurinDoor using these settings:

**Local DurinDoor:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any DurinDoor model (cc/*, cx/*, glm/*, etc.)
```

**Cloud DurinDoor:**
```
Base URL: https://bloodf.github.io/durindoor/v1
API Key: your-api-key-from-dashboard
Model: any DurinDoor model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to DurinDoor
```bash
...
- Check network connection to DurinDoor
