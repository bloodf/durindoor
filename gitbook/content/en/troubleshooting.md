...
Common issues and solutions when using DurinDoor.
...
1. **Auto-refresh (default):**
   DurinDoor automatically refreshes tokens. Wait 30 seconds and retry.
...
4. **Use cloud endpoint:**
   ...
   ```
   Endpoint: https://bloodf.github.io/durindoor/v1
   ```
...
1. **Check if DurinDoor is running:**
   ```bash
   # Check process
   ps aux | grep durindoor
...
- **GitHub Issues:** [github.com/bloodf/durindoor/issues](https://github.com/bloodf/durindoor/issues)
