...
export default {
  ...
  transport: {
    ...
    // quirks: { dropOutputConfig: true, preservePromptCacheKey: true }, // latter: Chat endpoint accepts a client Responses prompt_cache_key on the Responses→Chat hop (default: stripped)
