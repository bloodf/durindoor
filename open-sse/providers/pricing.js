...
export const MODEL_PRICING = {
  ...
  /** Official Pro tiers have no cached-input discount; exact rows must beat cheaper family fallbacks. */
  "gpt-5-pro": { input: 15.00, output: 120.00, cached: 15.00, reasoning: 120.00, cache_creation: 15.00 },
...
{ pattern: "claude-fable-*", pricing: { input: 10.00, output: 50.00, cached: 1.00, reasoning: 50.00, cache_creation: 12.50 } },
...
{ pattern: "grok-4.5-*", pricing: { input: 2.00, output: 6.00, cached: 0.30, reasoning: 6.00, cache_creation: 2.00, longContextThreshold: 200000, longContextInclusive: true, longContextInputMultiplier: 2, longContextOutputMultiplier: 2 } },
// One row covers grok-4.3 and its documented grok-4.3-latest alias.
