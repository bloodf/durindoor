export default {
  ...
  display: {
    ...
    notice: {
      text: "OpenAI-compatible endpoint with free daily credits. VIP models consume pi credits.",
      apiKeyUrl: "https://www.bluesminds.com",
    },
  },
  category: "apikey",
  transport: {
  ...
  modelsFetcher: { url: "https://api.bluesminds.com/v1/models", type: "openai" },
};
