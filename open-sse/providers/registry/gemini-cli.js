...
export default {
  ...
  transport: {
    ...
    clientId: GOOGLE_OAUTH_CLIENT.clientId, // Set via env var — see SECRETS_AND_CONFIG.md
    clientSecret: GOOGLE_OAUTH_CLIENT.clientSecret, // Set via env var — see SECRETS_AND_CONFIG.md
  },
  models: [
