...
// Codex CLI sends this bare virtual model id for auto-review — keep it on
// OAuth Codex instead of falling through to the "openai" default, which has
// no credentials for it (port of decolua/9router#4135).
