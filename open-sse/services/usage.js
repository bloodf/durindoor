...
const USAGE_HANDLERS = {
  ...
  glm: (c) => getGlmUsage(c.apiKey, c.provider, c.providerSpecificData, c.proxyOptions),
  "glm-cn": (c) => getGlmUsage(c.apiKey, c.provider, c.providerSpecificData, c.proxyOptions),
