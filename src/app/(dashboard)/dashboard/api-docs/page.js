  ...
  return <div className="mx-auto flex w-full max-w-6xl flex-col gap-4">
    ...
    <Card padding={false}>
      ...
      <CardContent className="space-y-3 text-[13px] leading-5 text-dd-muted">
        ...
        <pre className="overflow-x-auto rounded-dd border border-dd-border-subtle bg-dd-surface-2 p-4 font-mono text-xs leading-5 text-dd-text"><code>{CHAT_COMPLETIONS_CURL}</code></pre>
      </CardContent>
    </Card>
  </div>;
}
