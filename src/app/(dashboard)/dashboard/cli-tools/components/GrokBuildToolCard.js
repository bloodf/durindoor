...
name = "DurinDoor"
description = "Routed via DurinDoor gateway"
      ...
      <button type="button" aria-expanded={isExpanded} className="w-full text-left outline-none focus-visible:shadow-dd-focus flex items-start justify-between gap-3 hover:cursor-pointer sm:items-center" onClick={onToggle}>
        ...
        <div className="flex min-w-0 items-center gap-3">
          <div className="size-8 flex items-center justify-center shrink-0">
            <Image
              src={tool.image || "/providers/grok-web.png"}
              alt={tool.name}
              width={32}
              height={32}
      ...
      <div className="mt-4 pt-4 border-t border-dd-border flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 p-4 bg-dd-warning/10 border border-dd-warning/30 rounded-dd-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-dd-warning">Grok Build not detected locally</p>
                    <p className="text-sm text-dd-muted mt-1">Install:</p>
                    <code className="block mt-2 p-2 bg-dd-surface-3 rounded-dd text-xs font-mono">curl -fsSL https://x.ai/cli/install.sh | bash</code>
                ...
                className="w-full sm:w-auto !bg-dd-surface !border-dd-warning/40 !text-dd-warning">
        ...
        <>
            ...
            <div className="flex flex-col gap-2 mb-2">
              ...
              <div
                key={idx}
                className={`flex items-start gap-2 p-2 rounded-dd text-xs ${
            ...
            <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-[8rem_auto_1fr_auto] sm:items-center sm:gap-2">
                ...
                className={`w-full sm:w-auto rounded-dd border px-2 py-2 text-xs transition-colors sm:py-1.5 whitespace-nowrap sm:shrink-0 ${
                hasActiveProviders ?
                "bg-dd-surface border-dd-border text-dd-text hover:border-dd-accent cursor-pointer" :
          ...
          <div className={`flex items-center gap-2 px-2 py-1.5 rounded-dd text-xs ${message.type === "success" ? "bg-dd-success/10 text-dd-success" : "bg-dd-danger/10 text-dd-danger"}`}>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="secondary" size="sm" onClick={handleReset} disabled={!grokStatus?.has9Router} loading={restoring} className="w-full sm:w-auto">
