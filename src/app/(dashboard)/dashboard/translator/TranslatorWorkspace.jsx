      ...
      {expanded ? (
        <>
          <CardContent className="space-y-3">
            <div role="region" tabIndex={0} aria-label={`${step.label} editor`} className="dd-monaco-surface min-h-11 overflow-hidden rounded-dd bg-dd-surface-2 outline-none focus-visible:shadow-dd-focus">
              <Editor
                height="400px"
