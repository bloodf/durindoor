  ...
  return (
    <Card padding={false} className="flex flex-col gap-0">
      ...
      <CardContent className="flex flex-col gap-4">
        {loading ? <div role="status" aria-label="Loading quota data" className="flex flex-col gap-3"><div className="h-4 animate-pulse rounded-dd bg-dd-surface-3" /><div className="h-3 animate-pulse rounded-dd bg-dd-surface-3" /><div className="h-4 animate-pulse rounded-dd bg-dd-surface-3" /></div> : null}
