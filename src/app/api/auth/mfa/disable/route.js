...
/**
 * Turn MFA off (decolua/9router#4144). Requires BOTH the current password and
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ error: "MFA disable failed" }, { status: 500, headers: NO_STORE_HEADERS });
  }
}
