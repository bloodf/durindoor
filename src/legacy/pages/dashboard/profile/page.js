...
import { Card, Button, Toggle, Input } from "@/legacy/shared/components";
import Modal, { ConfirmModal } from "@/legacy/shared/components/Modal";
import LanguageSwitcher from "@/legacy/shared/components/LanguageSwitcher";
import { useTheme } from "@/shared/hooks/useTheme";
import UiVersionSwitch from "@/legacy/shared/components/UiVersionSwitch";
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.9router/db/data.sqlite (DurinDoor data directory)</p>
              </div>
            </div>
