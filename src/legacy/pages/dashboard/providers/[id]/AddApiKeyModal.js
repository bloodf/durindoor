...
import { Button, Badge, Input, Modal, Select } from "@/legacy/shared/components";
...
import {
  ...
  createAddApiKeyModalInitialState } from
"./apiKeyConnectionName";
      ...
      try {
        const res = await fetch("/api/providers", {
          ...
          body: JSON.stringify({
            ...
            testStatus: "unknown",
            createOnly: true,
            ...(entry.providerSpecificData ? { providerSpecificData: entry.providerSpecificData } : null)
          })
        });
