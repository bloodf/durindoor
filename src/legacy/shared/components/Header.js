...
import ProviderIcon from "@/legacy/shared/components/ProviderIcon";
import HeaderMenu from "@/legacy/shared/components/HeaderMenu";
import HeaderLanguage from "@/legacy/shared/components/HeaderLanguage";
import ThemeToggle from "@/legacy/shared/components/ThemeToggle";
...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/mitm"))
    return {
      ...
      description: translate("Intercept CLI tool traffic and route through DurinDoor"),
      icon: "security",
      breadcrumbs: [],
    };
  ...
  if (pathname.includes("/skills"))
    return {
      ...
      description: translate("Copy a link and paste to your AI to use DurinDoor — no install needed"),
      icon: "extension",
      breadcrumbs: [],
    };
