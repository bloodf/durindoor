...
/**
 * Apply a source-model mapping and replace conflicting native thinking controls
 * when an explicit reasoning effort is configured for that Antigravity source.
 */
