...
function convertOpenAIToKiro(chunk, state) {
  ...
  if (frames.length === 0) {
    return state.initialSent ? null : withInitialFrame(state, null);
  }
...
module.exports = { intercept, buildEventStreamFrame, buildInitialResponseFrame, convertOpenAIToKiro, crc32, initKiroState };