...
export const CLI_TOOLS = {
  ...
  amp: {
    ...
    notes: [
      { type: "info", text: "Use DurinDoor model aliases to keep Amp shorthand mappings stable across provider updates." },
    ...
    guideSteps: [
      ...
      { step: 5, title: "Add Shorthands", desc: "Map Amp shorthand names such as g25p or cs45 to DurinDoor aliases in your local config." },
    ],
    codeBlock: {
      language: "bash",
