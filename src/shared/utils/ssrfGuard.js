...
//
// DurinDoor extension: `fetchImpl` lets callers route every hop through a
// custom fetch (e.g. the per-connection proxyAwareFetch in the search
// dispatcher) without giving up the per-hop re-validation. Defaults to the
// global fetch, matching upstream #3714 behavior.
export async function fetchPublic(url, init = {}, { maxRedirects = 5, fetchImpl } = {}) {
