...
function installHandoffMock(finalText, options = {}) {
  const calls = {
    conversationDetail: 0,
    resume: [],
  };

  __setTlsFetchOverrideForTesting(async (url, request = {}) => {
...
test("ChatGPT Web GPT-5.6 Sol Pro resumes Temporary Chat handoffs through native SSE", async () => {
