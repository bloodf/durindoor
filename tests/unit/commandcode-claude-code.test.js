/**
 * Claude Code driving Command Code end-to-end (port of decolua/9router #4224):
 * tool names must survive the round trip through the commandcode envelope,
 * and only the final authoritative tool call reaches the client.
 */
