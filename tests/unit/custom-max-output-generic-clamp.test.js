...
describe("DefaultExecutor generic custom maxOutput clamp", () => {
  it("clamps max_tokens and max_completion_tokens; never invents fields", async () => {
    ...
    const out = await ex.transformRequest("custom-x", body, false, {}, { modelCapabilities: { maxOutput: 2048 } });
    ...
    const out2 = await ex.transformRequest("custom-x", body2, false, {}, { modelCapabilities: { maxOutput: 2048 } });
