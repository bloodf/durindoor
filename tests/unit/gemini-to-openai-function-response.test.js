 ...
 *
 * Exercised through translateRequest() (not the exported geminiToOpenAIRequest
 * directly) because the fix overrides the format registry entry, and the
 * registry — not the named export — is what the router actually calls.
 */
